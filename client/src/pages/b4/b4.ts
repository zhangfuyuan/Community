...
export class B4Page {
  ...
  constructor(public navCtrl: NavController,
    ...
    this.getApplicationItems(isUser, isUser?global.userInfo.username:global.userInfo.community, '客户续约');
  }
  ...
  postDetail(post) {
    if (!this.form.b4.address)
      return this.presentToast('请输入续约地址！');
