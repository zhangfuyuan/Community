...
export class MyCommunityPage {
  ...
  bannerItems = [
    {
      ...
      "bannerId": 'f1523438892444',
      "pictureId" : "ad-4"
    }, {
      "bannerId": 'f1523439959464',
      "pictureId" : "ad-5"
    }
  ];
  noticeItems = [];
  ...
  constructor(public navCtrl: NavController,
    ...
    events.subscribe('getNewBanner', (index, banner) => { this.bannerItems[index] = banner; console.log(6)});
  ...
  ngOnDestroy() {
    ...
    this.events.unsubscribe('readNewBanner');
  }
}
